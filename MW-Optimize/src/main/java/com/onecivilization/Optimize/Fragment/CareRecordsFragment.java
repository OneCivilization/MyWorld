 ...
 */
public class CareRecordsFragment extends Fragment {
    ...
    private class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindRecord(Record record, int position) {
            if (position == selectedRecordPosition) {
                itemView.setBackgroundColor(0x29888888);
            } else {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (selectedRecordPosition != -1) {
                        recordsList.getChildAt(selectedRecordPosition).setBackgroundColor(Color.TRANSPARENT);
                    }
