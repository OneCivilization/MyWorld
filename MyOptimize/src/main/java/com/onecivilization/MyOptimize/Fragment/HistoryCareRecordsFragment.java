...
public class HistoryCareRecordsFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        care = (NonperiodicCare) DataManager.getInstance().getHistoryCareList().get(getActivity().getIntent().getIntExtra("careItemPosition", -1));
    }
        ...
        recordsCalendar.setOnDateClickedListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (calendar.getTimeInMillis() <= care.getCreateTime()) {
                    ...
                    return;
                } else if (calendar.getTimeInMillis() - 86400000 > care.getArchivedTime()) {
                    Toast.makeText(getActivity(), R.string.care_item_has_been_archived, Toast.LENGTH_SHORT).show();
                    return;
                }
